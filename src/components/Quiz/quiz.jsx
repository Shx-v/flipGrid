...
const QuizComponent = () => {
  ...
  const handleRetry=()=>{
    setQuestionsData(selectRandomQuestions());
    handleStartQuiz();
  }
    ...
    <div className="container h-screen">
      {currentQuestion == -1 ? (
        ...
        <div>
          ...
          <button
            className="option mt-4 w-[130px] flex justify-center ml-auto"
        ...
        <div>
          ...
          {{ score } != 3 ? (
            <>
            {/* setScore(0); */}
            <button className="bg-slate-500" onClick={handleRetry} >Retry</button>
            </>
          ) : (
            <div className="score">You earned {/* value */} coins</div>
          )}
